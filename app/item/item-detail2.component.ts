...
import { EventData } from "data/observable"; // added for button TODO
import { Button } from "ui/button";         // added for submit
...
export class ItemDetail2Component implements OnInit, AfterViewInit {
    ...
    constructor(@Inject(AppStore) private store: Store<AppState>, private page: Page, private route: ActivatedRoute, private itemService: ItemService, private modal: ModalDialogService, private vcRef: ViewContainerRef, private routerExtensions: RouterExtensions, private cacheService: CacheService) { 
        this.page_size = 3;
        this.hint = {};
